...
const Profile = () => {
  ...
  const handleSaveProfilePicture = async (file) => {
    ...
    try {
      ...
      await axios.put(`https://nami-backend.onrender.com/api/profile/update/${id}`, updatedProfile);
  ...
  const handleSaveBio = async () => {
      ...
      await axios.put(`https://nami-backend.onrender.com/api/profile/update/${id}`, profile);
      setBioEditMode(false);
  }
